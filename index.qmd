...
2. Ian Van Buskirk, Brian Zaharatos, Aaron Clauset and Daniel Larremore. <em>If the data do not speak for themselves, how ought we to speak for the data?</em><br><br>
3. Diliara Valeeva. <em>Why Don’t We Ever Talk About Education When We Talk About Computational Social Science?</em><br><br>
4. Olga Zagovora and Ralf Lämmel. <em>Hey, ChatGPT, how does CSS research need to change? Research questions in CSS in the wake of the perceived LLM singularity</em><br><br>
5. Surendrabikram Thapa, Usman Naseem and Mehwish Nasim. <em>From Humans to Machines: Can ChatGPT-like LLMs Effectively Replace Human Annotators in NLP Tasks?</em> </td>
</tr>
<tr class="odd">
